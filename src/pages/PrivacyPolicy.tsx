          ...
          <div className="prose prose-gray max-w-none text-foreground">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li><strong>Datos de identificación:</strong> nombre, correo electrónico, número telefónico, razón social, RFC.</li>
                <li><strong>Datos de pago:</strong> información de facturación y datos bancarios procesados por terceros autorizados (no almacenamos datos de tarjetas).</li>
                <li><strong>Datos de uso:</strong> información sobre cómo interactúa con la Plataforma, preferencias, historial de actividad.</li>
                <li><strong>Contenido del usuario:</strong> imágenes, productos, catálogos o información que el usuario suba voluntariamente a la Plataforma.</li>
              </ul>
              <p className="mt-3 leading-relaxed">
                No recabamos datos personales sensibles de manera intencional.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>Generar catálogos e imágenes con inteligencia artificial a partir del contenido que el usuario cargue.</li>
                <li>Brindar soporte técnico y atención al cliente.</li>
                <li>Mejorar nuestros servicios y funcionalidades.</li>
                <li>Enviar notificaciones sobre actualizaciones, promociones o cambios en el servicio (el usuario puede cancelar estas comunicaciones en cualquier momento).</li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>Proveedores de servicios tecnológicos y de pago (ej. servidores en la nube, pasarelas de pago).</li>
            ...
            <section className="mb-8">
              ...
              <p className="leading-relaxed">
                CatalogoIa adopta medidas de seguridad administrativas, técnicas y físicas para proteger sus datos personales contra pérdida, acceso no autorizado, alteración o divulgación indebida.
              </p>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li><strong>Rectificar</strong> la información en caso de ser inexacta o incompleta.</li>
                <li><strong>Cancelar</strong> sus datos cuando considere que no se requieren para alguna de las finalidades señaladas.</li>
                <li><strong>Oponerse</strong> al tratamiento de sus datos para fines específicos.</li>
              </ul>
              <p className="mt-3 leading-relaxed">
                Para ejercer sus derechos ARCO, el usuario puede enviar un correo a: [tu correo de contacto] indicando su solicitud y acompañando identificación oficial.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="leading-relaxed">
                CatalogoIa puede utilizar cookies y tecnologías similares para mejorar la experiencia de usuario y analizar el uso de la Plataforma. El usuario puede deshabilitar cookies desde su navegador, aunque algunas funciones podrían no estar disponibles.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="leading-relaxed">
                CatalogoIa podrá modificar el presente Aviso de Privacidad en cualquier momento. Las modificaciones estarán disponibles en la Plataforma y entrarán en vigor a partir de su publicación.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-none space-y-2">
                <li><strong>Correo electrónico:</strong> [tu correo de soporte]</li>

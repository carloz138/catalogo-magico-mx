...
import { LayoutDashboard, ShoppingCart, Settings, ArrowRight, Shirt, Hammer, Gem, Dog, Anvil, Radar } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-50 p-4 md:p-8 font-sans">
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm mb-8 flex flex-col md:flex-row items-center justify-between sticky top-4 z-40">
         ...
         <div className="flex items-center gap-4 w-full md:w-auto mt-4 md:mt-0">
             ...
             <Button className="h-11 bg-emerald-600 hover:bg-emerald-700 shadow-lg shadow-emerald-200 text-white" onClick={() => window.location.href='/register'}>
      ...
      <div className="max-w-7xl mx-auto pb-20">
        ...
        <Tabs defaultValue="dashboard" className="w-full">
            <TabsList className="bg-white p-1 border border-slate-200 h-12 rounded-xl mb-6 shadow-sm inline-flex">
                <TabsTrigger value="dashboard" className="h-10 px-6 data-[state=active]:bg-indigo-50 data-[state=active]:text-indigo-700 font-medium">
                    <LayoutDashboard className="w-4 h-4 mr-2"/> Dashboard
                </TabsTrigger>
                <TabsTrigger value="catalogo" className="h-10 px-6 data-[state=active]:bg-indigo-50 data-[state=active]:text-indigo-700 font-medium">

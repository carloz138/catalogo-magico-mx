  ...
  return (
    <div className="container mx-auto p-4 md:p-6 space-y-6">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Papelera de Productos</h1>
          <p className="text-gray-600">Administra los productos eliminados</p>
        </div>
        ...
        {loading ? (
          ...
          <Card>
            <CardContent className="p-12 text-center">
              ...
              <h3 className="font-semibold text-lg mb-2">No hay productos en la papelera</h3>
                ...
                <CardContent className="p-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Eliminado{" "}
                      {formatDistanceToNow(new Date(product.deleted_at), {
                        addSuffix: true,
                        locale: es,
                      })}
                    </p>

...
export const ProductForm = ({ product, imageUrl, onUpdate, priceDisplayMode = "both" }: ProductFormProps) => {
  ...
  // Helper para evitar NaN en inputs numéricos
  ...
  // Bloqueo de Scroll accidental en inputs numéricos
            ...
            <div className="space-y-2">
              <div className="flex flex-wrap gap-2 items-center min-h-[2rem]">
                ...
                {(product.tags || []).map(tag => (
                  <Badge key={tag} variant="secondary" className="pl-2 pr-1 py-1 flex items-center gap-1 bg-gray-100 text-gray-700 hover:bg-gray-200">
                    {tag}
                    <div 

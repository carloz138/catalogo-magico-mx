...
Deno.serve(async (req) => {
    ...
    try {
        ...
        if (isDistributable) {
            ...
            if (existingReplica) {
                // ⬅️ FIX DE RUTA: Alineación con el frontend /track
                ...
                const { error: insertError } = await supabaseAdmin
                    ...
                    .insert({
                        ...
                        is_active: false,
                        // CRÍTICO: FIX DE INTEGRIDAD. distributor_id es el dueño del catálogo
                ...
                // 1.3. Construir el Magic Link (Fase C) - ⬅️ FIX DE RUTA: Alineación con el frontend /track
...
// --- HELPERS (Replicados aquí para ser auto-contenido) ---
